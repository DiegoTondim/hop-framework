...
{
    public class HopControllerCrudBase<TController, TService, TNewCommand, TUpdateCommand, TRemoveCommand, TPrimaryKeyType, TFilter, TResponse, TPaginatedResponse>
        ...
        where TFilter : FilterBase
    {
        ...
        public HopControllerCrudBase(TService service, ILogger<TController> logger, IDispatcher dispatcher)
